...
class TestTC06Changingauthorname():
  ...
  def test_tC06Changingauthorname(self, username, password, data):
...
if __name__ == '__main__':
  ...
  file2 = open( "TC06TestData.json")
  
  login = json.load(file1)
  test_data = json.load(file2)
  
  testcase6 = TestTC06Changingauthorname()
  testcase6.setup_method(1)
  
  for dataa in test_data["data"]:
    testcase6.test_tC06Changingauthorname(login["username"], login["password"], dataa)
